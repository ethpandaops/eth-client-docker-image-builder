...
$HOME/go/bin/bazelisk build //cmd/beacon-chain:beacon-chain --config=release --define pgo_enabled=0 --enable_bzlmod=false --remote_cache=grpc://bazel-remote-cache-grpc.primary.staging.platform.ethpandaops.io:80
